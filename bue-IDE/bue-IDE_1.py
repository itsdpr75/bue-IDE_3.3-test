...
class Node:
    ...
    def draw(self, surface):
        ...
        pygame.draw.rect(surface, self.color, self.rect.inflate(-4, -4), border_radius=10)
        ...
        content_text = font.render(self.content, True, WHITE)
        ...
        for i, input_name in enumerate(self.inputs):
            ...
            pygame.draw.circle(surface, RED, (self.rect.left, int(y)), 10)
            text = font.render(input_name, True, WHITE)
        ...
        for i, output_name in enumerate(self.outputs):
            ...
            pygame.draw.circle(surface, GREEN, (self.rect.right, int(y)), 10)
            text = font.render(output_name, True, WHITE)
...
class Connection:
    ...
    def draw(self, surface):
        ...
        control1 = (start_pos[0] + 50, start_pos[1])
        control2 = (end_pos[0] - 50, end_pos[1])
        pygame.draw.lines(surface, BLUE, False, [start_pos, control1, control2, end_pos], 2)
